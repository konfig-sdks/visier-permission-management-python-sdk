...
SchemaFor200ResponseBodyApplicationJson = PermissionDTOSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_permission_mapped_args(
        self,
        permission_id: str,
    ...
    async def _aget_permission_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/admin/permissions/{permissionId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetPermissionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_permission(
        self,
        permission_id: str,
        tenant_code: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_permission_mapped_args(
            permission_id=permission_id,
            tenant_code=tenant_code,
        )
        return await self._aget_permission_oapg(
    ...
    def get_permission(
        ...
        return self._get_permission_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPermission(BaseApi):
    ...
    async def aget_permission(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PermissionDTOPydantic:
        raw_response = await self.raw.aget_permission(
            permission_id=permission_id,
            tenant_code=tenant_code,
            **kwargs,
        )
        if validate:
            return PermissionDTOPydantic(**raw_response.body)
        return api_client.construct_model_instance(PermissionDTOPydantic, raw_response.body)
    ...
    def get_permission(
        ...
        raw_response = self.raw.get_permission(
            permission_id=permission_id,
            tenant_code=tenant_code,
        )
        if validate:
