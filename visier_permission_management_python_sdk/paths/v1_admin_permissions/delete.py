...
class BaseApi(api_client.Api):
    ...
    def _delete_permissions_mapped_args(
        self,
        body: str,
    ...
    async def _adelete_permissions_oapg(
        self,
...
class DeletePermissionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_permissions(
        self,
        body: str,
        tenant_code: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._delete_permissions_mapped_args(
            body=body,
            tenant_code=tenant_code,
        )
        return await self._adelete_permissions_oapg(
            body=args.body,
    ...
    def delete_permissions(
        ...
        return self._delete_permissions_oapg(
            body=args.body,
            query_params=args.query,
        )
...
class DeletePermissions(BaseApi):
    ...
    async def adelete_permissions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_permissions(
            body=body,
            tenant_code=tenant_code,
            **kwargs,
        )
    ...
    def delete_permissions(
        ...
        raw_response = self.raw.delete_permissions(
            body=body,
            tenant_code=tenant_code,
        )
        if validate:
