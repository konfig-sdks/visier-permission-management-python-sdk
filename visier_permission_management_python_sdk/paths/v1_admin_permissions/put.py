...
class BaseApi(api_client.Api):
    ...
    def _update_permissions_mapped_args(
        self,
    ...
    async def _aupdate_permissions_oapg(
        self,
...
class UpdatePermissionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_permissions(
        self,
        permissions: typing.Optional[typing.List[PermissionDTO]] = None,
        tenant_code: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._update_permissions_mapped_args(
            permissions=permissions,
            tenant_code=tenant_code,
        )
        return await self._aupdate_permissions_oapg(
            body=args.body,
...
class UpdatePermissions(BaseApi):
    ...
    async def aupdate_permissions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_permissions(
            permissions=permissions,
            tenant_code=tenant_code,
            **kwargs,
        )
    ...
    def update_permissions(
        ...
        raw_response = self.raw.update_permissions(
            permissions=permissions,
            tenant_code=tenant_code,
        )
        if validate:
